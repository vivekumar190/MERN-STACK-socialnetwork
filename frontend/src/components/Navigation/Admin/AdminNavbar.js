...
import { Dropdown, Text, Grid, User ,Button} from "@nextui-org/react";
...
const navigation = [
  ...
  { name: "Explore Societies", href: "/societies", current: false },
];
          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="flex-shrink-0 flex items-center">
                {/* Logo */}
              <img src="https://cdn-icons.flaticon.com/png/512/3426/premium/3426127.png?token=exp=1659028683~hmac=88a19c61106887ff245dcfa3d251f172" width={50} height={50}></img>
              </div>
      ...
      <Grid>
        <Dropdown placement="bottom-left">
          ...
          <Dropdown.Menu color="primary" aria-label="User Actions">
            ...
            <Dropdown.Item key="team_settings">Dashboard</Dropdown.Item>
