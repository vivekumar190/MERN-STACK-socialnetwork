        ...
        <div class="py-0 min-h-screen radius-for-skewed  ">
          <div class="container mx-auto px-4">
            <div class="mb-0 flex flex-wrap items-center">
              ...
              <div class=" block text-right w-1/2">{/* View All */}</div>
            </div>
            <div class="flex flex-wrap -mx-3">
              <div class="mb-8 lg:mb-0 w-full lg:w-1/4 px-3"></div>
                    ...
                    categoryList?.map((category) => (
                      <Grid>
                        <Button
                          ...
                          onClick={() =>
                            dispatch(
                              fetchPostsAction({ category: category?.title })
                            )
                          }
                          flat
                          color="secondary"
                      ...
                      >
                        ...
                        >
                          <Grid.Container gap={0} alignContent="center">
                            ...
                            {post?.society?.handle ? (
                              <Link to={`/societies/${post?.society?._id}`}>
                                <Text size={17} color="secondary" b>
                                  •{post?.society?.handle}
                                </Text>
                              </Link>
                            ) : null}
                          ...
                          {post?.user?._id === userAuth?._id ? (
                            <Link to={`/update-post/${post?.id}`}>
                              <Image
                                src="https://cdn-icons.flaticon.com/png/512/4620/premium/4620789.png?token=exp=1659818371~hmac=560eddca31daa8cfe3c27a7c683b6730"
                                alt="Default Image"
                                width={20}
                                height={20}
                              />
                        ...
                        <Card.Body css={{ p: 0 }}>
                          {post?.image.split(".").pop() === "png" ||
                          post?.image.split(".").pop() === "jpeg" ||
                          post?.image.split(".").pop() === "jpg" ||
                          post?.image.split(".").pop() === "PNG" ||
                          post?.image.split(".").pop() === "JPEG" ||
                          post?.image.split(".").pop() === "JPG" ? (
                            <Card.Image
                            ...
                            <div className="player-wrapper">
                              <ReactPlayer
                                ...
                                onPlay={() =>
                                  dispatch(fetchPostDetailsAction(post?.id))
                                }
                                controls={true}
                                playsinline={true}
                                url={post?.image}
                          ...
                          {post?.comments.length > 0 ? (
                            <Grid.Container>
                              <Grid>
                                <User
                                  size="xs"
                                  src={post?.comments[0]?.user?.profilePhoto}
                                  name={
                                    post?.comments[0]?.user?.firstName +
                                    "-commented: " +
                                    post?.comments[0]?.description
                                  }
                                ></User>
                              </Grid>
                            ...
                            <Text color="error">
                              No Comments Yet <AddComment post={post} />
                            </Text>
                          )}
                        </Card.Body>
                        {/* <Card.Divider /> */}
